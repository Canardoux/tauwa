...
use web_audio_api as wars;
use web_audio_api::context::BaseAudioContext as wars_base_audio_context;    
use flutter_rust_bridge::frb;

type AudioContextState = String;
type AudioContextRenderSizeCategory = String;
type AudioContextLatencyCategory = String;
type AudioSinkType = String;
...
pub struct EventHandler {}// TODO
pub struct JSArray<T> {js_array: T} // TODO
pub struct JSArrayBuffer {} // TODO
pub struct JSPromise<T> {js_promise: T} // TODO

#[frb(opaque)]
pub struct MediaStream
{
        delegate: wars::media_streams::MediaStream,
...
{
        delegate: wars::media_streams::MediaStreamTrack,
...
{
  /// Internal : don't use
  fn get_delegate(&self) -> &impl wars::context::BaseAudioContext;
  ...
  /// > [AnalyserNode] page.
  fn create_analyser(&self) -> AnalyserNode {AnalyserNode{delegate: self.get_delegate().create_analyser()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_biquad_filter(&self) -> BiquadFilterNode {BiquadFilterNode{delegate: self.get_delegate().create_biquad_filter()}}
  ...
  fn create_buffer(
        &self,
    numberOfChannels: usize,
    length: usize,
    sampleRate: usize,
  ) -> AudioBuffer {AudioBuffer{delegate: self.get_delegate().create_buffer()}}
  ...
  /// > see
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_buffer_source(&self) -> AudioBufferSourceNode {AudioBufferSourceNode{delegate: self.get_delegate().create_buffer_source()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_channel_merger(&self, numberOfInputs: Option<usize>) -> ChannelMergerNode {ChannelMergerNode{delegate: self.get_delegate().create_channel_merger()}}
  ...
  /// > see
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_channel_splitter(&self, numberOfOutputs: Option<usize>) -> ChannelSplitterNode {ChannelSplitterNode{delegate: self.get_delegate().create_channel_splitter()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_constant_source(&self) -> ConstantSourceNode {ConstantSourceNode{delegate: self.get_delegate().create_constant_source()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_convolver(&self) -> ConvolverNode {ConvolverNode{delegate: self.get_delegate().create_convolver()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn  create_delay(&self, maxDelayTime: Option<f64>) -> DelayNode {DelayNode{delegate: self.get_delegate().create_delay()}}
  ...
  /// > see
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_dynamics_compressor(&self) -> DynamicsCompressorNode {DynamicsCompressorNode{delegate: self.get_delegate().create_dynamics_compressor()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_gain(&self) -> GainNode {GainNode{delegate: self.get_delegate().create_gain()}}
  ...
  fn create_iir_filter(
        &self,
    feedforward: JSArray<f64>,
    feedback: JSArray<f64>,
  ) -> IIRFilterNode {IIRFilterNode{delegate: self.get_delegate().create_iir_filter()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn  create_oscillator(&self) -> OscillatorNode {OscillatorNode{delegate: self.get_delegate().create_oscillator()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_panner(&self) -> PannerNode {PannerNode{delegate: self.get_delegate().create_panner()}}
  ...
  ) -> PeriodicWave {PeriodicWave{delegate: self.get_delegate().create_periodic_wave()}}
  ...
  fn create_script_processor(
    ...
    numberOfInputChannels: Option<usize>,
    numberOfOutputChannels: Option<usize>,
  ) -> ScriptProcessorNode {ScriptProcessorNode{delegate: self.get_delegate().create_script_processor()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_stereo_panner(&self) -> StereoPannerNode {StereoPannerNode{delegate: self.get_delegate().create_stereo_panner()}}
  ...
  /// > [Creating an AudioNode](https://developer.mozilla.org/en-US/docs/Web/API/AudioNode#creating_an_audionode).
  fn create_wave_shaper(&self) -> WaveShaperNode {WaveShaperNode{delegate: self.get_delegate().create_wave_shaper()}}
  ...
  fn  decodeAudioData(
        &self,
    audioData: JSArrayBuffer,
    // [LARPOUX] Not implented // successCallback: Option<DecodeSuccessCallback>,
    // [LARPOUX] Not implented // errorCallback: Option<DecodeErrorCallback>,
  ) -> JSPromise<AudioBuffer> {JSPromise{js_promise: self.get_delegate().decodeAudioData(audioData)}}
  ...
  fn  get_destination(&self) -> AudioDestinationNode {AudioDestinationNode{}}
  ...
  fn get_sample_rate(&self) -> f32 {self.get_delegate().sample_rate()}
  ...
  /// starts at 0.
  fn get_current_time(&self) -> f64 {self.get_delegate().current_time()}
  ...
  fn get_listener(&self) -> AudioListener {AudioListener{}}

  /// The `state` read-only property of the [BaseAudioContext]
  /// interface returns the current state of the `AudioContext`.
  fn get_state(&self) -> AudioContextState {self.get_delegate().state()}
  ...
  /// processing.
  fn get_audio_worklet(&self) -> AudioWorklet {AudioWorklet{}}
  fn get_onstatechange(&self) -> EventHandler {EventHandler{}}
  fn set_onstatechange(&self, value: EventHandler) {}
}
...
{
        delegate: wars::context::AudioContext,
}
...
impl AudioContext
{
  ...
  fn getOutputTimestamp(&self) -> AudioTimestamp {AudioTimestamp{}}
  ...
  fn resume(&self) -> JSPromise {JSPromise{js_promise: self.delegate.resume()}}
  ...
  /// This method will cause an `INVALID_STATE_ERR` exception to be thrown if
  /// called on an [OfflineAudioContext].
  fn suspend(&self) -> JSPromise {JSPromise{jss_promise: self.delegate.suspend()}}
  ...
  /// [OfflineAudioContext].
  fn close(&self) -> JSPromise {self.delegate.close()}
  ...
  fn create_media_element_source(&self,
      mediaElement: MediaElement) -> MediaElementAudioSourceNode {MediaElementAudioSourceNode{delegate: self.delegate.create_media_element_source(mediaElement.delegate)}}
  ...
  fn create_media_stream_source(&self,
       mediaStream: MediaStream) -> MediaStreamAudioSourceNode {MediaStreamAudioSourceNode{delegate: self.delegate.create_media_stream_source(mediaStream.delegate)}}
  ...
  fn create_media_stream_track_source(&self,
       mediaStreamTrack: MediaStreamTrack) -> MediaStreamTrackAudioSourceNode {MediaStreamTrackAudioSourceNode{delegate: self.delegate.create_media_stream_track_source(mediaStreamTrack.delegate)}}
  ...
  fn create_media_stream_destination(&self) -> MediaStreamAudioDestinationNode {MediaStreamAudioDestinationNode{delegate: self.delegate.createMedia_stream_destination()}}
  ...
  fn get_base_latency(&self) -> f64 {self.delegate.base_latency()}
  ...
  fn get_output_latency(&self) -> f64 {self.delegate.output_latency()}
...
{
        delegate: wars::context::OfflineAudioContext,
...
{
        delegate: wars::OfflineAudioCompletionEvent,
...
pub struct OfflineAudioCompletionEventInit
{
        ...
        delegate: wars::OfflineAudioCompletionEventInit,
...
{
        delegate: wars::node::AudioScheduledSourceNode,
...
{
        delegate: wars::node::AnalyserNode,
...
{
        delegate: wars::node::AudioBufferSourceNode,
...
{
        delegate: wars::node::AudioDestinationNode,
...
{
        delegate: wars::AudioProcessingEvent,
...
{
        delegate: wars::AudioProcessingEventInit,
...
{
        delegate: wars::node::BiquadFilterNode,
...
{
        delegate: wars::node::ChannelMergerNode,
...
{
        delegate: wars::node::ChannelSplitterNode,
...
{
        delegate: wars::node::ConstantSourceNode,
...
{
        delegate: wars::node::ConvolverNode,
...
{
        delegate: wars::node::DynamicsCompressorNode,
...
{
        delegate: wars::node::IIRFilterNode,
...
{
        delegate: wars::node::MediaElementAudioSourceNode,
...
{
        delegate: wars::node::MediaStreamAudioDestinationNode,
...
{
        delegate: wars::node::MediaStreamAudioSourceNode,
...
{
        delegate: wars::node::MediaStreamTrackAudioSourceNode,
...
{
        delegate: wars::node::OscillatorNode,
...
{
        delegate: wars::PeriodicWaveConstraints,
...
{
        delegate: wars::node::ScriptProcessorNode,
...
{
        delegate: wars::node::StereoPannerNode,
...
{
        delegate: wars::node::WaveShaperNode,
...
{
        delegate: wars::worklet::AudioWorkletGlobalScope,
...
{
        delegate: wars::worklet::AudioWorkletNode,
...
{
        delegate: wars::AudioWorkletProcessor,
